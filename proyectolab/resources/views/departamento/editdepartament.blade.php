      ...
      <div class="modal fade" id="ConfirmarSalida" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <h2>EDITAR REGISTROS</h2>
          ...
          @endif
            ...
            <form action="/departaments/{{$departament->id}}" method="POST">
              @csrf    
              @method('PUT')
            <div class="mb-3">
              <label for="" class="form-label">Código del Departamento:</label>
                <input id="name_departament" name="name_departament" type="text" class="form-control"  value="{{$departament->name_departament}}">    
              </div>
            ...
            <div class="mb-3">
              <label for="" class="form-label">Descripción del Departamento:</label>
                <input id="descrip_departament" name="descrip_departament" type="text" class="form-control" value="{{$departament->descrip_departament}}">
              </div>
            ...
            <div class="mb-3">
              ...
              <input id="status" name="status" type="hidden" value="{{$departament->status}}">


            </div>

            <a href="/departaments" class="btn btn-secondary">Cancelar</a>
